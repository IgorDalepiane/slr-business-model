...
\author{Rafael~Ribeiro,~\IEEEmembership{Master's~Student,}
        Igor~Dalepiane,~\IEEEmembership{Master's~Student,}
        and~Maicon~Bernardino,~\IEEEmembership{Advisor}% <-this % stops a space
\thanks{R. Ribeiro and I. Dalepiane are Master's students at the Postgraduate Program in Software Engineering (PPGES), 
Federal University of Pampa (UNIPAMPA), Alegrete Campus, RS, Brazil.}% <-this % stops a space
\thanks{M. Bernardino is an advisor professor at the Postgraduate Program in Software Engineering (PPGES), 
Federal University of Pampa (UNIPAMPA), Alegrete Campus, RS, Brazil.}}
...
% The paper headers
\markboth{Journal of Software Engineering Research and Development}%
{Ribeiro \MakeLowercase{\textit{et al.}}: Systematic Literature Review on Business Models}
...
\begin{figure}[!htb]
    \centering
    \input{tikz/quality_classification}
...
\input{tables/business_models_distribution}
...
\input{tables/implementation_challenges}
